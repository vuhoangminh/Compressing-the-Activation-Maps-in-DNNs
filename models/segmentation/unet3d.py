...
class UNet(Module):
    ...
    def __init__(
        self, num_channels=1, feat_channels=[64, 256, 256, 512, 1024], residual="conv"
    ):
...
class Conv3D_Block(Module):
    def __init__(
        self, inp_feat, out_feat, kernel=3, stride=1, padding=1, residual=None
    ):
...
if __name__ == "__main__":
    ...
    net = UNet(num_channels=3, residual="pool").cuda().eval()
