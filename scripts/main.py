...
parser.add_argument(
    ...
    # default="database/options/mnist/mnistnet_compressed_wt_db3_0.9999_3_conv1-relu1-conv2-maxpool.yaml",
    # default="database/options/mnist/mnistnet_compressed_wt_db3_0.1_3_conv1-relu1-conv2-maxpool.yaml",
    ...
    # default="database/options/mnist/mnistnet_compressed.yaml",
    ...
    # default="database/options/brats/unet_compressed_regu_wt_db3_0.9_3_conv2.yaml",
    # default="database/options/brats/unet_compressed_regu_wt_db3_0.99_3_conv2.yaml",
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if options["data"]["dataset"] in ["mnist", "cifar10", "cifar100", "imagenet"]:
        ...
        if is_training:
            ...
            if experiment is not None:  # comet-ml
                with experiment.train():
                    best_metric = T.perform_train_validiate(
                        args,
                        options,
                        train_sampler,
                        train_loader,
    ...
    elif options["data"]["dataset"] in ["brats"]:
